...
const TechInfo: React.FC<TechInfoProps> = ({ technology }) => {
  ...
  return (
    <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50 animate-fadeInUp">
      <div className="bg-black/80 backdrop-blur-xl border border-white/20 rounded-2xl p-6 max-w-md mx-4 shadow-2xl">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${getLevelColor(technology.level)} text-white mt-1`}>
              {technology.level}
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-purple-300 font-medium capitalize">
            {technology.category}
          </span>
        </div>
